...
class Compradores(models.Model):
  ...
  compradorApellidoPat = models.CharField(max_length=50, verbose_name='Comprador Apellido Paterno')
  compradorApellidoMat = models.CharField(max_length=50, verbose_name='Comprador Apellido Materno')
  compradorTelefono = models.IntegerField(verbose_name='Teléfono')
...
class Vendedores(models.Model):
  ...
  vendedorApellidoPat = models.CharField(max_length=50, verbose_name='Comprador Vendedor Paterno')
  vendedorApellidoMat = models.CharField(max_length=50, verbose_name='Comprador Vendedor Materno')
...
class Ventas(models.Model):
  id = models.AutoField(primary_key=True)
  vendedorrut = models.ForeignKey(Vendedores, on_delete=models.CASCADE, verbose_name='Rut Vendedor')
  idauto = models.ForeignKey(Auto, on_delete=models.CASCADE, verbose_name='ID Auto')
  fechaventa = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')
  compradorrut = models.ForeignKey(Compradores, on_delete=models.CASCADE, verbose_name='Rut Comprador')
  id_detalle = models.ForeignKey(Detalles, on_delete=models.CASCADE, verbose_name='ID Detalle')
